...
function Tienda() {
  return (
    <>
      <Seo
        title="Tienda Poketiempo MX | Merch climatico y drops de temporada"
        description="Explora la tienda de Poketiempo MX con merch, stickers, prints y objetos inspirados en lluvias, calor, frentes frios y huracanes."
        path="/tienda"
      />
